...
private Q_SLOTS:
    ...
    void testRoundTripHosts()
    {
        ...
        original.append({QString(), {}, QStringLiteral("# Managed by Fedora Lowlevel Settings")});
    ...
    void testWriteKeyValueHeader()
    {
        ...
        QVERIFY(content.startsWith(QStringLiteral("# Generated by Fedora Lowlevel Settings")));
    }
